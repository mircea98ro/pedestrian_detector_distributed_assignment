...
def cfg_creator():
    ...
    rospy.set_param('cfg/yolo/max_iou', 0.4)
    rospy.set_param('cfg/yolo/min_obj_confidence', 0.5)
    rospy.set_param('cfg/yolo/min_score', 0.5)
    ...
    rospy.set_param('/master/export', 0)
